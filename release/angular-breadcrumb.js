...
(function (window, angular, undefined) {
    ...
    function BreadcrumbDirective($interpolate, $breadcrumb, $rootScope, $timeout) {
        var $$templates = {
        ...
        return {
            ...
            link: {
                post: function postLink(scope) {
                    ...
                    var setLabels = function (viewScope) {
    ...
    BreadcrumbDirective.$inject = ['$interpolate', '$breadcrumb', '$rootScope', '$timeout'];
